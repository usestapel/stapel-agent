...
_LONG_RUNNING = {
    ...
    "llm.summarize": llm_summarize,
    "llm.diarize": llm_diarize,
}


def _register_long_running_as_tasks() -> None:
    from stapel_core.comm import register_task

    for kind, handler in _LONG_RUNNING.items():
        try:
...
_register_long_running_as_tasks()
