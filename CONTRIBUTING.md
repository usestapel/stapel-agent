...
```bash
git clone https://github.com/usestapel/stapel-agent.git && cd stapel-agent
...
The packages use a flat layout (`package-dir = {{"stapel_agent": "."}}`), so the
